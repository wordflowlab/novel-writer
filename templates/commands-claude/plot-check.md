...
allowed-tools: Read(//spec/tracking/plot-tracker.json), Read(spec/tracking/plot-tracker.json), Read(//outline.md), Read(outline.md), Read(//stories/**/content/**), Read(stories/**/content/**), Bash(find:*), Bash(wc:*), Bash(*)
